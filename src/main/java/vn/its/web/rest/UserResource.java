...
import vn.its.service.MailService;
import vn.its.service.UserService;
import vn.its.service.dto.UserDTO;
import vn.its.web.rest.errors.BadRequestAlertException;
import vn.its.web.rest.errors.EmailAlreadyUsedException;
import vn.its.web.rest.errors.LoginAlreadyUsedException;
import vn.its.web.rest.util.HeaderUtil;
import vn.its.web.rest.util.PaginationUtil;
